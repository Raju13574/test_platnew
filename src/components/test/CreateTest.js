...
const CreateTest = () => {
    ...
    try {
      ...
      const preparedData = {
        ...
        codingChallenges: testData.codingChallenges.map(challenge => ({
          ...
          allowedLanguages: challenge.allowedLanguages || ['javascript', 'typescript']
        })),
  ...
  // Add helper functions for default templates
  const getDefaultTemplate = (language) => {
    const templates = {
      javascript: `function solution(input) {\n    // Write your code here\n    \n}`,
      typescript: `function solution(input: string): any {\n    // Write your code here\n    \n}`,
  ...
  const getDefaultTestHelper = (language) => {
    const helpers = {
      ...
      typescript: `export default solution;`,
                      ...
                      <FormControl fullWidth required>
                        ...
                        <Select
                          ...
                          onChange={(e) => {
                            ...
                            // Initialize language implementations for newly selected languages
                            e.target.value.forEach(lang => {
                              if (!newChallenges[index].languageImplementations?.[lang]) {
                                if (!newChallenges[index].languageImplementations) {
                                  newChallenges[index].languageImplementations = {};
                                }
                                newChallenges[index].languageImplementations[lang] = {
