...
const Wallet = () => {
  ...
  const handleAddMoney = async (amount) => {
    // Show message to contact admin instead of processing payment
    toast('Please contact admin to add funds to your wallet');
    
    // Commented out Razorpay integration logic
    /*
    try {
