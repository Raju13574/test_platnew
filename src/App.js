...
import Companies from './pages/vendor/Companies';
import ActiveCompanies from './pages/vendor/ActiveCompanies';
              ...
              <ProtectedRoute 
                element={
                  <Routes>
                    ...
                    <Route path="companies/active" element={<ActiveCompanies />} />
                  </Routes>
                } 
              ...
              <ProtectedRoute 
                element={
                  <Routes>
                    ...
                    <Route path="test-results/:testId/:submissionId" element={<UserTestResult />} />
                  </Routes>
                } 
                allowedRoles={['user', 'admin']} 
              />
